...
```
# mkdir /nfs
# mount -t nfs 12.xxx.xxx.16:/nfs /nfs
# ls /nfs
# touch /nfs/suyefile
# ls /nfs
# umount /nfs
...
vi /etc/hosts
12.xxx.xxx.160 master1
12.xxx.xxx.161 node1
12.xxx.xxx.162 node2
...
kubeadm init
kubeadm init --apiserver-advertise-address=12.xxx.xxx.160 --pod-network-cidr=172.16.0.0/16
...
kubeadm join 12.xxx.xxx.160:6443 --v=5 --node-name=node2 --token q3j7yc.u57xcy3sl2zm74yr \
